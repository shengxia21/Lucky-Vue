...
public interface ISysMenuService {
     ...
     * @return 结果
     */
    int insertMenu(SysMenuSaveQuery menu);
     ...
     * @return 结果
     */
    int updateMenu(SysMenuSaveQuery menu);
     ...
     * @return 结果
     */
    boolean checkMenuNameUnique(SysMenuSaveQuery menu);
     ...
     * @return 结果
     */
    boolean checkRouteConfigUnique(SysMenuSaveQuery menu);
