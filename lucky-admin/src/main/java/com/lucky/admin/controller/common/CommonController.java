package com.lucky.admin.controller.common;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response) {
        try {
            ...
            String filePath = LuckyConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) {
        try {
            // 上传文件路径
            String filePath = LuckyConfig.getUploadPath();
            // 上传并返回新文件名称
    ...
    public void resourceDownload(String resource, HttpServletResponse response) {
        try {
            ...
            // 本地资源路径
            String localPath = LuckyConfig.getProfile();
            // 数据库资源地址
