package com.lucky.common.utils.poi;
...
import com.lucky.common.utils.file.FileTypeUtils;
import com.lucky.common.utils.file.FileUtils;
import com.lucky.common.utils.file.ImageUtils;
import com.lucky.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = LuckyConfig.getDownloadPath() + filename;
    ...
    private void createExcelField() {
        ...
        this.fields = this.fields.stream().sorted(Comparator.comparing(objects -> ((Excel) objects[1]).sort())).toList();
