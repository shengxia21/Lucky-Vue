package com.lucky.common.mybatis.aspectj;
...
import com.lucky.common.security.context.PermissionContextHolder;
...
public class DataScopeAspect {
     ...
     */
    public static void dataScopeFilter(JoinPoint joinPoint, UserDTO user, String userAlias, String deptAlias, String userField, String deptField, String permission) {
        ...
        if (StringUtils.isNotBlank(sqlString.toString())) {
            ...
            if (StringUtils.isNotNull(params) && params instanceof DataScopeEntity dataScopeEntity) {
                dataScopeEntity.getParams().put(DATA_SCOPE, " AND (" + sqlString.substring(4) + ")");
            }
        }
    }
    ...
    private void clearDataScope(final JoinPoint joinPoint) {
        Object params = joinPoint.getArgs()[0];
        if (StringUtils.isNotNull(params) && params instanceof DataScopeEntity dataScopeEntity) {
            dataScopeEntity.getParams().put(DATA_SCOPE, "");
        }
    }
