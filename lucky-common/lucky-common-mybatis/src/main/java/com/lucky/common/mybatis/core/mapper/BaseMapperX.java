package com.lucky.common.mybatis.core.mapper;
...
public interface BaseMapperX<T, V> extends BaseMapper<T> {
    ...
    default Class<V> currentVoClass() {
        return (Class<V>) GenericTypeUtils.resolveTypeArguments(this.getClass(), BaseMapperX.class)[1];
    }
    ...
    default Class<T> currentModelClass() {
        return (Class<T>) GenericTypeUtils.resolveTypeArguments(this.getClass(), BaseMapperX.class)[0];
    }
