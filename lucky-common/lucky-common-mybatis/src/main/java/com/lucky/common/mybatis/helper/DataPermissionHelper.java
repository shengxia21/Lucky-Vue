package com.lucky.common.mybatis.helper;
...
public class DataPermissionHelper {
    ...
    private static IgnoreStrategy getIgnoreStrategy() {
        Object ignoreStrategyLocal = ReflectUtil.getStaticFieldValue(ReflectUtil.getField(InterceptorIgnoreHelper.class, "IGNORE_STRATEGY_LOCAL"));
